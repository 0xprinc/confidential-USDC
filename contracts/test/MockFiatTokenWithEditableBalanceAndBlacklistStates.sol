...
contract MockFiatTokenWithEditableBalanceAndBlacklistStates is FiatTokenV2_2 {
     ...
     */
    function setBalanceAndBlacklistStates(address _account, uint256 _state) external {
     ...
     */
    function getBalanceAndBlacklistStates(address _account) external view returns (uint256) {
     ...
     */
    function internal_setBlacklistState(address _account, bool _shouldBlacklist) external {
     ...
     * @dev Exposes the internal function for unit testing.
     */
    function internal_isBlacklisted(address _account) external view returns (bool) {
     ...
     * @dev Exposes the internal function for unit testing.
     */
    function internal_balanceOf(address _account) external view returns (uint256) {
