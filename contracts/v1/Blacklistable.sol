...
abstract contract Blacklistable is Ownable {
    ...
    mapping(address => ebool) public _deprecatedBlacklisted;
     ...
     */
    function isBlacklisted(address _account) public returns (ebool) {
     ...
     */
    function _isBlacklisted(address _account) internal virtual returns (ebool);
